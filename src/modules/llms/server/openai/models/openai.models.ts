...
export const _knownOpenAIChatModels: ManualMappings = [
  ...
  // GPT-4o
  {
    ...
    chatPrice: { input: 30, cache: { cType: 'oai-ac', read: 30 }, output: 30 },
  ...
  },
  {
    ...
    chatPrice: { input: 30, output: 30 /* TODO: AUDIO 10/20 */ },
    isPreview: true,
  },
  {
  ...
  // GPT-4o Realtime Preview
  {
    ...
    chatPrice: { input: 30, cache: { cType: 'oai-ac', read: 30 }, output: 30 /* TODO: AUDIO 100/200 */ },
    isPreview: true,
  },
  {
  ...
  // GPT-4o Audio Preview
  {
    ...
    trainingDataCutoff: 'Oct 2023',
    interfaces: [LLM_IF_OAI_NeedsAudio],
    chatPrice: { input: 30, output: 30 /* TODO: AUDIO 100/200 */ },
    isPreview: true,
  },
  {
    ...
    trainingDataCutoff: 'Oct 2023',
    interfaces: [LLM_IF_OAI_NeedsAudio],
    chatPrice: { input: 30, output: 30 /* TODO: AUDIO 40/80 */ },
    isPreview: true,
    hidden: true,
  },
  {
